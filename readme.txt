...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\piratequesting on
     Windows, /home/user/dev/piratequesting on Linux) in a file named
     piratequesting@pq.ashita.org and copy that file to
